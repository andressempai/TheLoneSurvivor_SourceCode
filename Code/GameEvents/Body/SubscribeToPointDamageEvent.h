#ifndef SUBSCRIBE_TO_POINT_DAMAGE_EVENT_H
#define SUBSCRIBE_TO_POINT_DAMAGE_EVENT_H
...
namespace GameEvents::Body {
	struct SubscribeToPointDamageEvent {
...
#endif // !SUBSCRIBE_TO_POINT_DAMAGE_EVENT_H