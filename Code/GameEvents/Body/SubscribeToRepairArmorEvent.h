#ifndef SUBSCRIBE_TO_REPAIR_ARMOR_EVENT_H
#define SUBSCRIBE_TO_REPAIR_ARMOR_EVENT_H
...
namespace GameEvents::Body {
	struct SubscribeToRepairArmorEvent {
...
#endif // !SUBSCRIBE_TO_REPAIR_ARMOR_EVENT_H