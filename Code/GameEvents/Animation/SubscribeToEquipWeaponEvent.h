#ifndef SUBSCRIBE_TO_EQUIP_WEAPON_EVENT_H
#define SUBSCRIBE_TO_EQUIP_WEAPON_EVENT_H
...
namespace GameEvents::Animation {
	struct SubscribeToEquipWeaponEvent {
		explicit SubscribeToEquipWeaponEvent(user_code::animation::PlayerAnimation& player_animation);
