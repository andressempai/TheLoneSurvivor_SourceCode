#ifndef SUBSCRIBE_TO_RECOIL_EVENT_H
#define SUBSCRIBE_TO_RECOIL_EVENT_H
...
namespace GameEvents::Animation {
	struct SubscribeToRecoilEvent {
		explicit SubscribeToRecoilEvent(user_code::animation::PlayerAnimation& player_animation);
...
#endif // !SUBSCRIBE_TO_RECOIL_EVENT_H